...
track04's bytes and its file size — pure payload, read only after boot.
The trade-off: the mastered image embeds donor data (title shows as "Dolphin
Blue" in menus), acceptable for the local Phase 5 bring-up; re-introduce our
own IP/FS piece by piece from a *working* baseline afterwards.
